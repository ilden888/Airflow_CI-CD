...
dag = DAG(
    'ya_dir_up_TankServis',
    default_args=default_args,
    description='DAG для загрузки данных из Yandex Direct каждые 4 часа TankServis',
...
def main():
    token = 'y0_AgAAAABz3u0AAAtswwAAAAD-UVFMAADXGJs8EU1Ax6r4Tlo_aBI87UYzvg'
    clientLogin = 'ad-borishoftankservice'

    # Определение ID цели из раздела "Цели" Яндекс.Метрики
    goalID = [302393266, 302446690, 302446691, 302446692, 302393267, 302433926, 302446693, 305532078]  # замените это на реальный ID цели
...
def load_data_to_postgresql(df):
    ...
    class St2(Base):
        __tablename__ = 'TankServis_Direct_day'
    ...
    print("Данные успешно загружены в таблицу TankServis_Direct_day.")
